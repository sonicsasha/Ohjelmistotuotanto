...
class TestKauppa(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.viitegeneraattori_mock.uusi.side_effect = [42,84,126]
    ...
    def test_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla_monta_tuotetta(self):
    ...
    def test__pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla_monella_samalla_tuotteella(self):
    ...
    def test_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla_monta_tuotetta_yksi_loppu(self):
    ...
    def test_asiointi_nollaa_aikaisemmat_ostokset(self):
    ...
    def test_uusi_viitenumero_jokaiselle_ostokselle(self):
        ...
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
        self.pankki_mock.tilisiirto.assert_called_with(ANY, 84, ANY, ANY, ANY)
