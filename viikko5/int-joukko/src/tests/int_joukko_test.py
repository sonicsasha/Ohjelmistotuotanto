...
class TestIntJoukko(unittest.TestCase):
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertTrue(joukko.alkio_kuuluu_lukujonoon(11))
        joukko.poista(11)
        self.assertFalse(joukko.alkio_kuuluu_lukujonoon(11))
    ...
    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.alkio_kuuluu_lukujonoon(10))
        self.assertFalse(self.joukko.alkio_kuuluu_lukujonoon(5))
        self.assertTrue(self.joukko.alkio_kuuluu_lukujonoon(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista(3)
        self.assertFalse(self.joukko.alkio_kuuluu_lukujonoon(3))
